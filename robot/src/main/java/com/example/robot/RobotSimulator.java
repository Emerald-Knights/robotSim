...
public class RobotSimulator extends Canvas {
    ...
    static final int length=576; //size of frame
    ...
    public static void main(String[] args) {
        ...
        reset.setBounds(width-60, 20, 50, 30); //size and position of button
        ...
        pic.setSize(length, width); //canvas now is the size of the frame
    ...
    public void paint(Graphics g){
        ...
        bufferG.rotate(-robert.position.heading, robert.position.x +frame.getWidth()/2, robert.position.y +frame.getHeight()/2);
        bufferG.drawImage(bot, (int)robert.position.x-robotLen/2+frame.getWidth()/2,(int)robert.position.y-robotWid/2+frame.getHeight()/2, robotLen, robotWid,this);
